export function changeProductsHome(){
  ...
  document.querySelector('.image2').style.backgroundImage = 'url(./js-mod-14/assets/img/02.jpg)';
  document.querySelector('.image3').style.backgroundImage = 'url(./js-mod-14/assets/img/03.jpg)';
  document.querySelector('.image4').style.backgroundImage = 'url(./js-mod-14/assets/img/10.jpg)';
  document.querySelector('.image5').style.backgroundImage = 'url(./js-mod-14/assets/img/09.jpg)';
  document.querySelector('.image6').style.backgroundImage = 'url(./js-mod-14/assets/img/06.jpg)';
  document.querySelector('.image7').style.backgroundImage = 'url(./js-mod-14/assets/img/11.jpg)';
  document.querySelector('.image8').style.backgroundImage = 'url(./js-mod-14/assets/img/08.jpg)';
}
...
<div id="ctn-main"> 
  <img class="main-image" src="./js-mod-14/assets/img/imagem1.webp">
  <div id="ctn-main-txt"> 
    <p>Bolos Especiais</p>
    <p>para Casamentos</p>
    <p>e Festas</p>
  ...
  <img class="main-image" src="./js-mod-14/assets/img/imagem2.webp">
</div>  
</section>
